(function() {
  ...
  this.PaymentTag = (function() {
    ...
    PaymentTag.prototype.render = function() {
      ...
      this.$address_line1 = this.$('.address_line1 input');
      this.$address_line2 = this.$('.address_line2 input');
      this.$address_city = this.$('.address .city input');
      this.$address_state = this.$('.address .state input');
      this.$address_zip = this.$('.address .zip input');
      this.$address_country = this.$('.address_country input');
    ...
    PaymentTag.prototype.createToken = function(callback) {
      ...
      return Stripe.createToken({
        name: this.$name.val(),
        address_line1: this.$address_line1.val(),
        address_line2: this.$address_line2.val(),
        address_city: this.$address_city.val(),
        address_state: this.$address_state.val(),
        address_zip: this.$address_zip.val(),
        address_country: this.$address_country.val(),
...
(function() {
  ...
  this.PaymentTag["view"] = function(__obj) {
    ...
    (function() {
      (function() {
        compiled = _.template($('#tmpl-card').html(), {options: this.options});
        __out.push(compiled);
      }).call(this);
